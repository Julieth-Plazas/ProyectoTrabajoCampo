...
const Login = () => {
  ...
  return (
    <section class="bg-white flex items-start justify-center mt-16">
          ...
          <form action="" class="flex flex-col gap-4">
            ...
            <div class="relative">
              ...
              <svg
                ...
                viewBox="0 0 16 16"
                onClick={handleTogglePasswordVisibility} // Añadimos el manejador aquí
              >
            ...
            <button
              class="bg-teal-700 rounded-xl text-white py-2 hover:scale-105 duration-300"
